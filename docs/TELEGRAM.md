...
/relaypilot_update transit v0.1.0
...
```text
/relaypilot_update hub v0.1.0
/relaypilot_update transit v0.1.0
/relaypilot_update landing v0.1.0
/relaypilot_update all v0.1.0
/relaypilot_update transit-hk v0.1.0 --restart
```
